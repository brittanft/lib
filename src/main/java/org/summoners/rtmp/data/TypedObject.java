package org.summoners.rtmp.data;
...
public class TypedObject extends ObjectMap {
	...
	/**
	 * Initializes the type of the object, null type implies a dynamic class (used for headers and some other things)
	 * 
	 * @param type
	 ...
	 * 
	 * @param data
	 *            The data for the ArrayCollection
	 * @return
	 */
	...
	/**
	 * Convenience for retrieving object arrays Also handles flex.messaging.io.ArrayCollection
	 * 
	 * @param key
	 *            The key of the object array
